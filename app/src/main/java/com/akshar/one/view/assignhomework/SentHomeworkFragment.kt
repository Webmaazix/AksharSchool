...
import com.akshar.one.databinding.FragmentSentHomeworkBinding
...
class SentHomeworkFragment : Fragment() {

    private var currActivity : Activity? = null
    private var binding : FragmentSentHomeworkBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_sent_homework,container,false)
        initViews()
        return  binding?.root
    }
