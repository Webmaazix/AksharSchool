...
class ClassSectionAdapterForMessage(private val mContext: Activity, private val list: ArrayList<ClassDropDownModel>?,
                                    private var fragment : Fragment?
                           ,private var callback : SectionSelection) :
    RecyclerView.Adapter<ClassSectionAdapterForMessage.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(fragment!= null){
            val adapter = SectionAdapterForMessage(mContext,position,value,classModel.classroomsList ,fragment,classModel,
            ...
            val adapter = SectionAdapterForMessage(mContext,position,value,classModel.classroomsList ,null,classModel,object :SectionSelection{
                override fun selectionCallback(parent: Int, child: Int) {
                    selectedChild=child;
                    clickParent=parent;
                    callback.selectionCallback(parent,child)
