...
class FeeTermListAdapter(private val mContext: Activity, var parent: Int,
                               var child:Int, private val list: ArrayList<TermList>?, private var fragment: Fragment?,
                               private var model: FeeHeadTermList) :
    RecyclerView.Adapter<FeeTermListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvClassName.text = section!!.termName
