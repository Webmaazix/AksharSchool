package com.akshar.one.calender.widget
...
import com.akshar.one.calender.view.ExpandIconView
import com.akshar.one.calender.view.LockScrollView
import com.akshar.one.calender.view.OnSwipeTouchListener
...
//        mTodayIcon = rootView.findViewById(R.id.today_icon)
    ...
    protected fun setAttributes(attrs: TypedArray) {
        ...
        textColor = attrs.getColor(R.styleable.UICalendar_texttColor, textColor)
